...
{
    public class RabbitConsumerCentroTrabajoHostedService : AyniConsumerHostedService
    {
        public RabbitConsumerCentroTrabajoHostedService(IConfiguration configuration, IRabbitManagerConsumer rabbit) :
            base(configuration, rabbit, TipoConsumidor.ReplicaRegistro,
                Constante.RABBIT_EXCHANGE_NEGOCIO_COMUNES_MAESTROS_CENTRO_TRABAJO, Constante.RABBIT_QUEUE_NEGOCIO_COMUNES_MAESTROS_CENTRO_TRABAJO)
        {
        }
